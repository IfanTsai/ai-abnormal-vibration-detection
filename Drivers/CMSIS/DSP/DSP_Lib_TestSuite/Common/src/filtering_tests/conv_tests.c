        ...
        TEMPLATE_DO_ARR_DESC(                                                                  \
            ...
            TEMPLATE_DO_ARR_DESC(                                                              \
                ...
                TEST_CALL_FUT_AND_REF(                                                         \
                    fut, fut_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b),  \
                    ref, ref_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b)); \
                                                                                               \
                        ...
                        if (CONV_TEST_VALID_PARTIAL_PARAMS(                                                                         \
                            ...
                            memset(filtering_output_fut, 0,                                                                         \
                                   (2 * CONV_MAX_INPUT_ELTS) * sizeof(output_type));                                                \
                                                                                                                                    \
                            TEST_CALL_FUT_AND_REF(                                                                                  \
                                fut, fut_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b, first_index, num_points),  \
                                ref, ref_arg_interface(input_a_ptr, conv_len_a, input_b_ptr, conv_len_b, first_index, num_points)); \
                                                                                                                                    \
