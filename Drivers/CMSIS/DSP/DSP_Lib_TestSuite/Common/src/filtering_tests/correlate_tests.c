        ...
        TEMPLATE_DO_ARR_DESC(                                                                            \
            ...
            TEMPLATE_DO_ARR_DESC(                                                                        \
                ...
                TEST_CALL_FUT_AND_REF(                                                                   \
                    fut, fut_arg_interface(input_a_ptr, correlate_len_a, input_b_ptr, correlate_len_b),  \
                    ref, ref_arg_interface(input_a_ptr, correlate_len_a, input_b_ptr, correlate_len_b)); \
                                                                                                         \
