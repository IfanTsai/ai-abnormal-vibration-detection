...
#define MATRIX_DEFINE_MATRICES(suffix)                                                                                          \
    arm_matrix_instance_##suffix matrix_##suffix##_1x1_rand1 = { 1, 1, (TYPE_FROM_ABBREV(suffix) *)matrix_f32_100_rand };       \
    arm_matrix_instance_##suffix matrix_##suffix##_1x1_rand2 = { 1, 1, (TYPE_FROM_ABBREV(suffix) *)(matrix_f32_100_rand + 1) }; \
    arm_matrix_instance_##suffix matrix_##suffix##_1x1_zeros = { 1, 1, (TYPE_FROM_ABBREV(suffix) *)matrix_zeros };              \
                                                                                                                                \
    arm_matrix_instance_##suffix matrix_##suffix##_1x4_rand1 = { 1, 4, (TYPE_FROM_ABBREV(suffix) *)matrix_f32_100_rand };       \
    arm_matrix_instance_##suffix matrix_##suffix##_1x4_rand2 = { 1, 4, (TYPE_FROM_ABBREV(suffix) *)(matrix_f32_100_rand + 1) }; \
    arm_matrix_instance_##suffix matrix_##suffix##_1x4_zeros = { 1, 4, (TYPE_FROM_ABBREV(suffix) *)matrix_zeros };              \
                                                                                                                                \
    arm_matrix_instance_##suffix matrix_##suffix##_2x4_rand1 = { 2, 4, (TYPE_FROM_ABBREV(suffix) *)matrix_f32_100_rand };       \
    arm_matrix_instance_##suffix matrix_##suffix##_2x4_rand2 = { 2, 4, (TYPE_FROM_ABBREV(suffix) *)(matrix_f32_100_rand + 1) }; \
    arm_matrix_instance_##suffix matrix_##suffix##_2x4_zeros = { 2, 4, (TYPE_FROM_ABBREV(suffix) *)matrix_zeros };              \
                                                                                                                                \
    arm_matrix_instance_##suffix matrix_##suffix##_4x4_rand1 = { 4, 4, (TYPE_FROM_ABBREV(suffix) *)matrix_f32_100_rand };       \
    arm_matrix_instance_##suffix matrix_##suffix##_4x4_rand2 = { 4, 4, (TYPE_FROM_ABBREV(suffix) *)(matrix_f32_100_rand + 1) }; \
    arm_matrix_instance_##suffix matrix_##suffix##_4x4_zeros = { 4, 4, (TYPE_FROM_ABBREV(suffix) *)matrix_zeros }
