            ...
            TEMPLATE_DO_ARR_DESC(                                            \
                ...
                TEST_DO_VALID_BLOCKSIZE(                                     \
                    ...
                    TEST_CALL_FUT_AND_REF(                                   \
                        fut, fut_arg_interface(input_data_ptr, block_size),  \
                        ref, ref_arg_interface(input_data_ptr, block_size)); \
                                                                             \
                ...
                TEMPLATE_DO_ARR_DESC(                                                 \
                    ...
                    TEST_DO_VALID_BLOCKSIZE(                                          \
                        block_size, input_type, input_ptr,                            \
                                                                                      \
                        TEST_CALL_FUT_AND_REF(                                        \
                            fut, fut_arg_interface(input_data_ptr, elt, block_size),  \
                            ref, ref_arg_interface(input_data_ptr, elt, block_size)); \
                        compare_interface(block_size, output_type)))));               \
        return JTEST_TEST_PASSED;                                                     \
    } while (0)
                ...
                TEMPLATE_DO_ARR_DESC(                                                            \
                    ...
                    TEMPLATE_DO_ARR_DESC(                                                        \
                        ...
                        TEST_DO_VALID_BLOCKSIZE(                                                 \
                            block_size, input_type, input_ptr,                                   \
                            TEST_CALL_FUT_AND_REF(                                               \
                                fut, fut_arg_interface(input_data_ptr, elt1, elt2, block_size),  \
                                ref, ref_arg_interface(input_data_ptr, elt1, elt2, block_size)); \
                            compare_interface(block_size, output_type))))));                     \
        return JTEST_TEST_PASSED;                                                                \
    } while (0)
        ...
        TEMPLATE_DO_ARR_DESC(                                                          \
            ...
            TEMPLATE_DO_ARR_DESC(                                                      \
                ...
                TEST_DO_VALID_BLOCKSIZE(                                               \
                    block_size, input_type, input_ptr,                                 \
                    TEST_CALL_FUT_AND_REF(                                             \
                        fut, fut_arg_interface(input_a_ptr, input_b_ptr, block_size),  \
                        ref, ref_arg_interface(input_a_ptr, input_b_ptr, block_size)); \
                                                                                       \
                    compare_interface(block_size, output_type))));                     \
        return JTEST_TEST_PASSED;                                                      \
    } while (0)
...
#define TEST_TEMPLATE_ELT1(arr_desc_elts,                                                                                           \
    ...
    do {                                                                                                                            \
        TEMPLATE_DO_ARR_DESC(                                                                                                       \
            elt_idx, elt_type, elt, arr_desc_elts,                                                                                  \
            TEST_CALL_FUT_AND_REF(                                                                                                  \
                fut, fut_arg_interface(elt),                                                                                        \
                ref, ref_arg_interface(elt)); /* Comparison interfaces typically accept */ /* a block_size. Pass a dummy value 1.*/ \
        ...
        TEMPLATE_DO_ARR_DESC(                                                                                                                \
            ...
            elt_b_type *elt_b = ARR_DESC_ELT(                                                                                                \
                ...
                arr_desc_elts_b);                                                                                                            \
                                                                                                                                             \
            TEST_CALL_FUT_AND_REF(                                                                                                           \
                fut, fut_arg_interface(elt_a, elt_b),                                                                                        \
                ref, ref_arg_interface(elt_a, elt_b)); /* Comparison interfaces typically accept */ /* a block_size. Pass a dummy value 1.*/ \
            compare_interface(1, output_type));                                                                                              \
        return JTEST_TEST_PASSED;                                                                                                            \
    } while (0)
        ...
        TEMPLATE_DO_ARR_DESC(                                 \
            ...
            TEMPLATE_DO_ARR_DESC(                             \
                ...
                JTEST_DUMP_STRF("Block Size: %d\n",           \
                                (int)block_size);             \
                TEST_CALL_FUT_AND_REF(                        \
                    fut, fut_arg_interface(elt, block_size),  \
