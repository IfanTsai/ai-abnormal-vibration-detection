...
arm_biquad_casd_df1_inst_q15_init(ml_arm_biquad_casd_df1_inst_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|ii", kwlist, &self->instance->numStages, &self->instance->postShift)) {
    }
    return 0;
}
...
arm_matrix_instance_f32_init(ml_arm_matrix_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhO", kwlist, &self->instance->numRows, &self->instance->numCols, &pData)) {
...
arm_pid_instance_q15_init(ml_arm_pid_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhhhhhh", kwlist, &self->instance->A0, &self->instance->A1, &self->instance->A2, &self->instance->state, &self->instance->Kp, &self->instance->Ki, &self->instance->Kd)) {
    }
    return 0;
}
...
arm_pid_instance_q31_init(ml_arm_pid_instance_q31Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|iiiiiii", kwlist, &self->instance->A0, &self->instance->A1, &self->instance->A2, &self->instance->state, &self->instance->Kp, &self->instance->Ki, &self->instance->Kd)) {
    }
    return 0;
}
...
arm_pid_instance_f32_init(ml_arm_pid_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|fffffff", kwlist, &self->instance->A0, &self->instance->A1, &self->instance->A2, &self->instance->state, &self->instance->Kp, &self->instance->Ki, &self->instance->Kd)) {
    }
    return 0;
}
...
arm_linear_interp_instance_f32_init(ml_arm_linear_interp_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|iffO", kwlist, &self->instance->nValues, &self->instance->x1, &self->instance->xSpacing, &pYData)) {
...
arm_cfft_radix2_instance_q15_init(ml_arm_cfft_radix2_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hiihh", kwlist, &self->instance->fftLen, &self->instance->ifftFlag, &self->instance->bitReverseFlag, &self->instance->twidCoefModifier, &self->instance->bitRevFactor)) {
    }
    return 0;
}
...
arm_cfft_radix2_instance_f32_init(ml_arm_cfft_radix2_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hiihhf", kwlist, &self->instance->fftLen, &self->instance->ifftFlag, &self->instance->bitReverseFlag, &self->instance->twidCoefModifier, &self->instance->bitRevFactor, &self->instance->onebyfftLen)) {
    }
    return 0;
}
...
arm_cfft_instance_q15_init(ml_arm_cfft_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hh", kwlist, &self->instance->fftLen, &self->instance->bitRevLength)) {
    }
    return 0;
}
...
arm_rfft_instance_q15_init(ml_arm_rfft_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|iiii", kwlist, &self->instance->fftLenReal, &self->instance->ifftFlagR, &self->instance->bitReverseFlagR, &self->instance->twidCoefRModifier)) {
    }
    return 0;
}
...
arm_rfft_instance_f32_init(ml_arm_rfft_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|ihiii", kwlist, &self->instance->fftLenReal, &self->instance->fftLenBy2, &self->instance->ifftFlagR, &self->instance->bitReverseFlagR, &self->instance->twidCoefRModifier)) {
    }
    return 0;
}
...
arm_rfft_fast_instance_f32_init(ml_arm_rfft_fast_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|?h", kwlist, &self->instance->Sint, &self->instance->fftLenRFFT)) {
    }
    return 0;
}
...
arm_dct4_instance_f32_init(ml_arm_dct4_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhf", kwlist, &self->instance->N, &self->instance->Nby2, &self->instance->normalize)) {
    }
    return 0;
}
...
arm_dct4_instance_q31_init(ml_arm_dct4_instance_q31Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhi", kwlist, &self->instance->N, &self->instance->Nby2, &self->instance->normalize)) {
    }
    return 0;
}
...
arm_dct4_instance_q15_init(ml_arm_dct4_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhh", kwlist, &self->instance->N, &self->instance->Nby2, &self->instance->normalize)) {
    }
    return 0;
}
...
arm_fir_decimate_instance_q15_init(ml_arm_fir_decimate_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|ih", kwlist, &self->instance->M, &self->instance->numTaps)) {
    }
    return 0;
}
...
arm_fir_interpolate_instance_q15_init(ml_arm_fir_interpolate_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|ih", kwlist, &self->instance->L, &self->instance->phaseLength)) {
    }
    return 0;
}
...
arm_iir_lattice_instance_q15_init(ml_arm_iir_lattice_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hOO", kwlist, &self->instance->numStages, &pkCoeffs, &pvCoeffs)) {
...
arm_lms_instance_f32_init(ml_arm_lms_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hf", kwlist, &self->instance->numTaps, &self->instance->mu)) {
    }
    return 0;
}
...
arm_lms_instance_q15_init(ml_arm_lms_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhi", kwlist, &self->instance->numTaps, &self->instance->mu, &self->instance->postShift)) {
    }
    return 0;
}
...
arm_lms_instance_q31_init(ml_arm_lms_instance_q31Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hii", kwlist, &self->instance->numTaps, &self->instance->mu, &self->instance->postShift)) {
    }
    return 0;
}
...
arm_lms_norm_instance_f32_init(ml_arm_lms_norm_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hfff", kwlist, &self->instance->numTaps, &self->instance->mu, &self->instance->energy, &self->instance->x0)) {
    }
    return 0;
}
...
arm_lms_norm_instance_q31_init(ml_arm_lms_norm_instance_q31Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hiiii", kwlist, &self->instance->numTaps, &self->instance->mu, &self->instance->postShift, &self->instance->energy, &self->instance->x0)) {
    }
    return 0;
}
...
arm_lms_norm_instance_q15_init(ml_arm_lms_norm_instance_q15Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhihh", kwlist, &self->instance->numTaps, &self->instance->mu, &self->instance->postShift, &self->instance->energy, &self->instance->x0)) {
    }
    return 0;
}
...
arm_fir_sparse_instance_f32_init(ml_arm_fir_sparse_instance_f32Object *self, PyObject *args, PyObject *kwds)
{
    ...
    if (PyArg_ParseTupleAndKeywords(args, kwds, "|hhhO", kwlist, &self->instance->numTaps, &self->instance->stateIndex, &self->instance->maxDelay, &pTapDelay)) {
