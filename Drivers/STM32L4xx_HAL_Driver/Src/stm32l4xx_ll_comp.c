...
#define IS_LL_COMP_POWER_MODE(__POWER_MODE__) \
    (((__POWER_MODE__) == LL_COMP_POWERMODE_HIGHSPEED) || ((__POWER_MODE__) == LL_COMP_POWERMODE_MEDIUMSPEED) || ((__POWER_MODE__) == LL_COMP_POWERMODE_ULTRALOWPOWER))
...
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__) \
    (((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO2) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO3))
#else
#define IS_LL_COMP_INPUT_PLUS(__COMP_INSTANCE__, __INPUT_PLUS__) \
    (((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO1) || ((__INPUT_PLUS__) == LL_COMP_INPUT_PLUS_IO2))
#endif
...
#define IS_LL_COMP_INPUT_HYSTERESIS(__INPUT_HYSTERESIS__) \
    (((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_NONE) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_LOW) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_MEDIUM) || ((__INPUT_HYSTERESIS__) == LL_COMP_HYSTERESIS_HIGH))

#define IS_LL_COMP_OUTPUT_POLARITY(__POLARITY__) \
    (((__POLARITY__) == LL_COMP_OUTPUTPOL_NONINVERTED) || ((__POLARITY__) == LL_COMP_OUTPUTPOL_INVERTED))
...
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__COMP_INSTANCE__, __OUTPUT_BLANKING_SOURCE__)                                                                                                                                                    \
    (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE)                                                                                                                                                                             \
         ...
         : (((__COMP_INSTANCE__) == COMP1)                                                                                                                                                                                                  \
                ? (                                                                                                                                                                                                                         \
                      ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM2_OC3_COMP1) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM3_OC3_COMP1)) \
                : (                                                                                                                                                                                                                         \
                      ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM3_OC4_COMP2) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM8_OC5_COMP2) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM15_OC1_COMP2))))
#else
#if defined(TIM3)
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__COMP_INSTANCE__, __OUTPUT_BLANKING_SOURCE__) \
    (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE)                          \
...
#define IS_LL_COMP_OUTPUT_BLANKING_SOURCE(__COMP_INSTANCE__, __OUTPUT_BLANKING_SOURCE__) \
    (((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_NONE)                          \
         ? (                                                                             \
               (1UL))                                                                    \
         : (                                                                             \
               ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM1_OC5_COMP1) || ((__OUTPUT_BLANKING_SOURCE__) == LL_COMP_BLANKINGSRC_TIM2_OC3_COMP1)))
#endif /* TIM3 */
#endif /* COMP2 */
/**
  * @}
...
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx, LL_COMP_InitTypeDef *COMP_InitStruct)
{
    ...
    if (LL_COMP_IsLocked(COMPx) == 0UL) {
        ...
        MODIFY_REG(COMPx->CSR,
                   COMP_CSR_PWRMODE | COMP_CSR_INPSEL | COMP_CSR_SCALEN | COMP_CSR_BRGEN | COMP_CSR_INMESEL | COMP_CSR_INMSEL | COMP_CSR_HYST | COMP_CSR_POLARITY | COMP_CSR_BLANKING,
                   COMP_InitStruct->PowerMode | COMP_InitStruct->InputPlus | COMP_InitStruct->InputMinus | COMP_InitStruct->InputHysteresis | COMP_InitStruct->OutputPolarity | COMP_InitStruct->OutputBlankingSource);
#else
        MODIFY_REG(COMPx->CSR,
