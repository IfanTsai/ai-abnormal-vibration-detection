...
#define IS_LL_UTILS_PLLM_VALUE(__VALUE__) (((__VALUE__) == LL_RCC_PLLM_DIV_1) || ((__VALUE__) == LL_RCC_PLLM_DIV_2) || ((__VALUE__) == LL_RCC_PLLM_DIV_3) || ((__VALUE__) == LL_RCC_PLLM_DIV_4) || ((__VALUE__) == LL_RCC_PLLM_DIV_5) || ((__VALUE__) == LL_RCC_PLLM_DIV_6) || ((__VALUE__) == LL_RCC_PLLM_DIV_7) || ((__VALUE__) == LL_RCC_PLLM_DIV_8))
...
#define IS_LL_UTILS_PLL_FREQUENCY(__VALUE__) ((LL_PWR_GetRegulVoltageScaling() == LL_PWR_REGU_VOLTAGE_SCALE1) ? ((__VALUE__) <= UTILS_MAX_FREQUENCY_SCALE1) : ((__VALUE__) <= UTILS_MAX_FREQUENCY_SCALE2))
