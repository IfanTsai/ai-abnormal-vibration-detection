...
#define IS_LL_RTC_WEEKDAY(__VALUE__) (((__VALUE__) == LL_RTC_WEEKDAY_MONDAY) || ((__VALUE__) == LL_RTC_WEEKDAY_TUESDAY) || ((__VALUE__) == LL_RTC_WEEKDAY_WEDNESDAY) || ((__VALUE__) == LL_RTC_WEEKDAY_THURSDAY) || ((__VALUE__) == LL_RTC_WEEKDAY_FRIDAY) || ((__VALUE__) == LL_RTC_WEEKDAY_SATURDAY) || ((__VALUE__) == LL_RTC_WEEKDAY_SUNDAY))
...
#define IS_LL_RTC_ALMA_MASK(__VALUE__) (((__VALUE__) == LL_RTC_ALMA_MASK_NONE) || ((__VALUE__) == LL_RTC_ALMA_MASK_DATEWEEKDAY) || ((__VALUE__) == LL_RTC_ALMA_MASK_HOURS) || ((__VALUE__) == LL_RTC_ALMA_MASK_MINUTES) || ((__VALUE__) == LL_RTC_ALMA_MASK_SECONDS) || ((__VALUE__) == LL_RTC_ALMA_MASK_ALL))

#define IS_LL_RTC_ALMB_MASK(__VALUE__) (((__VALUE__) == LL_RTC_ALMB_MASK_NONE) || ((__VALUE__) == LL_RTC_ALMB_MASK_DATEWEEKDAY) || ((__VALUE__) == LL_RTC_ALMB_MASK_HOURS) || ((__VALUE__) == LL_RTC_ALMB_MASK_MINUTES) || ((__VALUE__) == LL_RTC_ALMB_MASK_SECONDS) || ((__VALUE__) == LL_RTC_ALMB_MASK_ALL))
