...
#define IS_LL_DAC_OUTPUT_CONNECTION(__OUTPUT_CONNECTION__) \
    (((__OUTPUT_CONNECTION__) == LL_DAC_OUTPUT_CONNECT_GPIO) || ((__OUTPUT_CONNECTION__) == LL_DAC_OUTPUT_CONNECT_INTERNAL))
