...
/**
  ...
  */
#define __LL_RCC_CALC_MSI_FREQ(__MSISEL__, __MSIRANGE__) (((__MSISEL__) == LL_RCC_MSIRANGESEL_STANDBY) ? (MSIRangeTable[(__MSIRANGE__) >> 8U]) : (MSIRangeTable[(__MSIRANGE__) >> 4U]))
