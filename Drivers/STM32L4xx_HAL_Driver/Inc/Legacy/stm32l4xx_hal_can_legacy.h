...
/**
  ...
  */
#define __HAL_CAN_MSG_PENDING(__HANDLE__, __FIFONUMBER__) (((__FIFONUMBER__) == CAN_FIFO0) ? ((uint8_t)((__HANDLE__)->Instance->RF0R & (uint32_t)0x03)) : ((uint8_t)((__HANDLE__)->Instance->RF1R & (uint32_t)0x03)))
...
#define __HAL_CAN_GET_FLAG(__HANDLE__, __FLAG__)                                                                                                                                                                                                                                        \
    ((((__FLAG__) >> 8) == 5) ? ((((__HANDLE__)->Instance->TSR) & (1U << ((__FLAG__)&CAN_FLAG_MASK))) == (1U << ((__FLAG__)&CAN_FLAG_MASK))) : (((__FLAG__) >> 8) == 2) ? ((((__HANDLE__)->Instance->RF0R) & (1U << ((__FLAG__)&CAN_FLAG_MASK))) == (1U << ((__FLAG__)&CAN_FLAG_MASK))) \
...
#define __HAL_CAN_CLEAR_FLAG(__HANDLE__, __FLAG__)                                                                                                                                                        \
    ((((__FLAG__) >> 8U) == 5) ? (((__HANDLE__)->Instance->TSR) = (1U << ((__FLAG__)&CAN_FLAG_MASK))) : (((__FLAG__) >> 8U) == 2) ? (((__HANDLE__)->Instance->RF0R) = (1U << ((__FLAG__)&CAN_FLAG_MASK))) \
...
#define __HAL_CAN_TRANSMIT_STATUS(__HANDLE__, __TRANSMITMAILBOX__)                                                                                                                                                                                                                                                                                                         \
    (((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_0) ? ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP0 | CAN_TSR_TXOK0 | CAN_TSR_TME0)) == (CAN_TSR_RQCP0 | CAN_TSR_TXOK0 | CAN_TSR_TME0)) : ((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_1) ? ((((__HANDLE__)->Instance->TSR) & (CAN_TSR_RQCP1 | CAN_TSR_TXOK1 | CAN_TSR_TME1)) == (CAN_TSR_RQCP1 | CAN_TSR_TXOK1 | CAN_TSR_TME1)) \
...
#define __HAL_CAN_CANCEL_TRANSMIT(__HANDLE__, __TRANSMITMAILBOX__)                                                                                                                             \
    (((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_0) ? ((__HANDLE__)->Instance->TSR |= CAN_TSR_ABRQ0) : ((__TRANSMITMAILBOX__) == CAN_TXMAILBOX_1) ? ((__HANDLE__)->Instance->TSR |= CAN_TSR_ABRQ1) \
