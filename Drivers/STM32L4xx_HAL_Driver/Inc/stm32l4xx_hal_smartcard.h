...
#define __HAL_SMARTCARD_DISABLE_IT(__HANDLE__, __INTERRUPT__) (((((__INTERRUPT__)&SMARTCARD_CR_MASK) >>                                            \
                                                                 SMARTCARD_CR_POS) == 1U)                                                          \
                                                                   ? ((__HANDLE__)->Instance->CR1 &= ~(1U << ((__INTERRUPT__)&SMARTCARD_IT_MASK))) \
                                                               : ((((__INTERRUPT__)&SMARTCARD_CR_MASK) >>                                          \
                                                                   SMARTCARD_CR_POS) == 2U)                                                        \
                                                                   ? ((__HANDLE__)->Instance->CR2 &= ~(1U << ((__INTERRUPT__)&SMARTCARD_IT_MASK))) \
...
#define __HAL_SMARTCARD_GET_IT(__HANDLE__, __INTERRUPT__) (                                                         \
    (((__HANDLE__)->Instance->ISR & (0x01UL << (((__INTERRUPT__)&SMARTCARD_ISR_MASK) >> SMARTCARD_ISR_POS))) != 0U) \
        ? SET                                                                                                       \
        : RESET)
