...
#define __HAL_USART_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                                                                                                                                                                                                         \
    (((((__INTERRUPT__)&USART_CR_MASK) >> USART_CR_POS) == 1U) ? ((__HANDLE__)->Instance->CR1 |= (1U << ((__INTERRUPT__)&USART_IT_MASK))) : ((((__INTERRUPT__)&USART_CR_MASK) >> USART_CR_POS) == 2U) ? ((__HANDLE__)->Instance->CR2 |= (1U << ((__INTERRUPT__)&USART_IT_MASK))) \
...
/** @brief  Check whether the specified USART interrupt has occurred or not.
  ...
  */
#define __HAL_USART_GET_IT(__HANDLE__, __INTERRUPT__) ((((__HANDLE__)->Instance->ISR & (0x01U << (((__INTERRUPT__)&USART_ISR_MASK) >> \
                                                                                                  USART_ISR_POS))) != 0U)             \
                                                           ? SET                                                                      \
                                                           : RESET)
...
/** @brief  Check whether the specified USART interrupt source is enabled or not.
  ...
  * @retval The new state of __INTERRUPT__ (SET or RESET).
  */
#define __HAL_USART_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) ((((((((uint8_t)(__INTERRUPT__)) >> 0x05U) == 0x01U) ? (__HANDLE__)->Instance->CR1 : (((((uint8_t)(__INTERRUPT__)) >> 0x05U) == 0x02U) ? (__HANDLE__)->Instance->CR2 : (__HANDLE__)->Instance->CR3)) & (0x01U << (((uint16_t)(__INTERRUPT__)) & \
                                                                                                                                                                                                                                                                               USART_IT_MASK))) != 0U)       \
                                                                  ? SET                                                                                                                                                                                                                                      \
                                                                  : RESET)
...
#define USART_GET_DIV_FACTOR(__CLOCKPRESCALER__)                                                                 \
    (((__CLOCKPRESCALER__) == USART_PRESCALER_DIV1) ? 1U : ((__CLOCKPRESCALER__) == USART_PRESCALER_DIV2) ? 2U   \
                                                       ...
                                                       : ((__CLOCKPRESCALER__) == USART_PRESCALER_DIV256) ? 256U \
                                                                                                          : 1U)
