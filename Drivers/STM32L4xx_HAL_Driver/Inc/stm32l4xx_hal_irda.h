...
/** @brief  Enable the specified IRDA interrupt.
  ...
  * @retval None
  */
#define __HAL_IRDA_ENABLE_IT(__HANDLE__, __INTERRUPT__) (((((__INTERRUPT__)&IRDA_CR_MASK) >> IRDA_CR_POS) == 1U) ? ((__HANDLE__)->Instance->CR1 |= (1U << ((__INTERRUPT__)&IRDA_IT_MASK))) : ((((__INTERRUPT__)&IRDA_CR_MASK) >> IRDA_CR_POS) == 2U) ? ((__HANDLE__)->Instance->CR2 |= (1U << ((__INTERRUPT__)&IRDA_IT_MASK))) \
...
/** @brief  Disable the specified IRDA interrupt.
  ...
  * @retval None
  */
#define __HAL_IRDA_DISABLE_IT(__HANDLE__, __INTERRUPT__) (((((__INTERRUPT__)&IRDA_CR_MASK) >> IRDA_CR_POS) == 1U) ? ((__HANDLE__)->Instance->CR1 &= ~(1U << ((__INTERRUPT__)&IRDA_IT_MASK))) : ((((__INTERRUPT__)&IRDA_CR_MASK) >> IRDA_CR_POS) == 2U) ? ((__HANDLE__)->Instance->CR2 &= ~(1U << ((__INTERRUPT__)&IRDA_IT_MASK))) \
                                                                                                                                                                                                                                                       : ((__HANDLE__)->Instance->CR3 &= ~(1U << ((__INTERRUPT__)&IRDA_IT_MASK))))
