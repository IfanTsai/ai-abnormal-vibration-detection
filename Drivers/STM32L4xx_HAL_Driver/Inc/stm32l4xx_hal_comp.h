...
#if defined(TIM3)
#define IS_COMP_BLANKINGSRCE(__OUTPUT_BLANKING_SOURCE__) \
    (((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_NONE) || ((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_TIM1_OC5_COMP1) || ((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_TIM2_OC3_COMP1) || ((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_TIM3_OC3_COMP1))
#else
#define IS_COMP_BLANKINGSRCE(__OUTPUT_BLANKING_SOURCE__) \
    (((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_NONE) || ((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_TIM1_OC5_COMP1) || ((__OUTPUT_BLANKING_SOURCE__) == COMP_BLANKINGSRC_TIM2_OC3_COMP1))
#endif /* TIM3 */
#endif /* COMP2 */
